...
<div class="col-12" id="content"> 
  ...
  <div class="text float-left">
    <p>
    Rybners HTX LAN er en begivenhed der finder sted flere gange om året på 
    rybners HTX. Formålet med vores LAN er at bringe skolen sammen, og 
    fjerne rammerne for alder. Det vil sige at vi holder et event for folk der har 
    interesse for computer og computerspil, også selvom man er 1. års elev kan man 
    stadig godt spille med en 3. års elev.
    <br><br>
    ...
    Servers:
    <br>
    Vi har en <a href="https://discord.me/htx_it">Discord server</a> som kan blive brugt under begivenheden, for at 
